                                ...
                                <div class="row mb-10 justify-content-center">
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="movie-grid">
                                            <div class="movie-thumb c-thumb">
                                                <a href="{{ route('movies.detail') }}">
                                                    <img src="assets/images/movie/movie01.jpg" alt="movie">
                                                </a>
                                            </div>
                                            <div class="movie-content bg-one">
                                                <h5 class="title m-0">
                                                    <a href="{{ route('movies.detail') }}">alone</a>
                                                </h5>
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="movie-grid">
                                            ...
                                            <div class="movie-content bg-one">
                                                <h5 class="title m-0">
                                                    <a href="{{ route('movies.detail') }}">mars</a>
                                                </h5>
                                                <ul class="movie-rating-percent">
                                                    <li>
                                                        <div class="thumb">
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="movie-grid">
                                            ...
                                            <div class="movie-content bg-one">
                                                <h5 class="title m-0">
                                                    <a href="{{ route('movies.detail') }}">venus</a>
                                                </h5>
                                                <ul class="movie-rating-percent">
                                                    <li>
                                                        <div class="thumb">
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="movie-grid">
                                            ...
                                            <div class="movie-content bg-one">
                                                <h5 class="title m-0">
                                                    <a href="{{ route('movies.detail') }}">on watch</a>
                                                </h5>
                                                <ul class="movie-rating-percent">
                                                    <li>
                                                        <div class="thumb">
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="movie-grid">
                                            ...
                                            <div class="movie-content bg-one">
                                                <h5 class="title m-0">
                                                    <a href="{{ route('movies.detail') }}">fury</a>
                                                </h5>
                                                <ul class="movie-rating-percent">
                                                    <li>
                                                        <div class="thumb">
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="movie-grid">
                                            ...
                                            <div class="movie-content bg-one">
                                                <h5 class="title m-0">
                                                    <a href="{{ route('movies.detail') }}">trooper</a>
                                                </h5>
                                                <ul class="movie-rating-percent">
                                                    <li>
                                                        <div class="thumb">
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="movie-grid">
                                            ...
                                            <div class="movie-content bg-one">
                                                <h5 class="title m-0">
                                                    <a href="{{ route('movies.detail') }}">horror night</a>
                                                </h5>
                                                <ul class="movie-rating-percent">
                                                    <li>
                                                        <div class="thumb">
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="movie-grid">
                                            ...
                                            <div class="movie-content bg-one">
                                                <h5 class="title m-0">
                                                    <a href="{{ route('movies.detail') }}">the lost name</a>
                                                </h5>
                                                <ul class="movie-rating-percent">
                                                    <li>
                                                        <div class="thumb">
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="movie-grid">
                                            ...
                                            <div class="movie-content bg-one">
                                                <h5 class="title m-0">
                                                    <a href="{{ route('movies.detail') }}">calm stedfast</a>
                                                </h5>
                                                <ul class="movie-rating-percent">
                                                    <li>
                                                        <div class="thumb">
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="movie-grid">
                                            ...
                                            <div class="movie-content bg-one">
                                                <h5 class="title m-0">
                                                    <a href="{{ route('movies.detail') }}">criminal on party</a>
                                                </h5>
                                                <ul class="movie-rating-percent">
                                                    <li>
                                                        <div class="thumb">
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="movie-grid">
                                            ...
                                            <div class="movie-content bg-one">
                                                <h5 class="title m-0">
                                                    <a href="{{ route('movies.detail') }}">halloween party</a>
                                                </h5>
                                                <ul class="movie-rating-percent">
                                                    <li>
                                                        <div class="thumb">
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="movie-grid">
                                            ...
                                            <div class="movie-content bg-one">
                                                <h5 class="title m-0">
                                                    <a href="{{ route('movies.detail') }}">the most wanted</a>
                                                </h5>
                                                <ul class="movie-rating-percent">
                                                    <li>
                                                        <div class="thumb">
                            ...
                            <div class="tab-item">
                                <div class="movie-area mb-10">
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="{{ route('movies.detail') }}" class="w-100 bg_img h-100" data-background="assets/images/movie/movie01.jpg">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="{{ route('movies.detail') }}" class="w-100 bg_img h-100" data-background="assets/images/movie/movie02.jpg">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="{{ route('movies.detail') }}" class="w-100 bg_img h-100" data-background="assets/images/movie/movie03.jpg">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="{{ route('movies.detail') }}" class="w-100 bg_img h-100" data-background="assets/images/movie/movie04.jpg">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="{{ route('movies.detail') }}" class="w-100 bg_img h-100" data-background="assets/images/movie/movie05.jpg">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="{{ route('movies.detail') }}" class="w-100 bg_img h-100" data-background="assets/images/movie/movie06.jpg">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="{{ route('movies.detail') }}" class="w-100 bg_img h-100" data-background="assets/images/movie/movie07.jpg">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="{{ route('movies.detail') }}" class="w-100 bg_img h-100" data-background="assets/images/movie/movie08.jpg">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="{{ route('movies.detail') }}" class="w-100 bg_img h-100" data-background="assets/images/movie/movie09.jpg">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="{{ route('movies.detail') }}" class="w-100 bg_img h-100" data-background="assets/images/movie/movie10.jpg">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="{{ route('movies.detail') }}" class="w-100 bg_img h-100" data-background="assets/images/movie/movie11.jpg">
                                    ...
                                    <div class="movie-list">
                                        <div class="movie-thumb c-thumb">
                                            <a href="{{ route('movies.detail') }}" class="w-100 bg_img h-100" data-background="assets/images/movie/movie12.jpg">
